...
def d_m_l_l_m_d():
    ...
    #         continue
    #     #candidate_c1_list = np.random.choice(len(miRNA_circRNA_list[m1]),int(1 * len(miRNA_circRNA_list[m1])),replace=False)
    #     candidate_c1_list = miRNA_circRNA_list[m]
    #     #candidate_c2_list = np.random.choice(len(miRNA_circRNA_list[m4]),int(1 * len(miRNA_circRNA_list[m4])),replace=False)
    #     candidate_c2_list = miRNA_circRNA_list[m4]
    ...
    # g_m_l_l_m_g = np.array(g_m_l_l_m_g)
