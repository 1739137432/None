...
def data_划分():
    ...
    if not os.path.exists('../output/relationship/VI_step_data_划分/'):
        os.makedirs('../output/relationship/VI_step_data_划分/')
    ...
    np.savez('../output/relationship/VI_step_data_划分/dis2mi_train_val_test_idx.npz', train_idx=dis2mi_train_idx, val_idx=dis2mi_val_idx, test_idx=dis2mi_test_idx)

    gace_data = np.load('../output/relationship/VI_step_data_划分/dis2mi_train_val_test_idx.npz')
    ...
    np.savez('../output/relationship/VI_step_data_划分/dis2gene_train_val_test_idx.npz', train_idx=dis2gene_train_idx, val_idx=dis2gene_val_idx, test_idx=dis2gene_test_idx)
    ...
    np.savez('../output/relationship/VI_step_data_划分/dis2circ_train_val_test_idx.npz', train_idx=dis2circ_train_idx, val_idx=dis2circ_val_idx, test_idx=dis2circ_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_划分/dis2lnc_train_val_test_idx.npz', train_idx=dis2lnc_train_idx, val_idx=dis2lnc_val_idx, test_idx=dis2lnc_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_划分/mi2circ_train_val_test_idx.npz', train_idx=mi2circ_train_idx, val_idx=mi2circ_val_idx, test_idx=mi2circ_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_划分/mi2lnc_train_val_test_idx.npz', train_idx=mi2lnc_train_idx, val_idx=mi2lnc_val_idx, test_idx=mi2lnc_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_划分/mi2gene_train_val_test_idx.npz', train_idx=mi2gene_train_idx, val_idx=mi2gene_val_idx, test_idx=mi2gene_test_idx)
    #
