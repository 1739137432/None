...
def data_划分():
    ...
    dis2mi_data = np.load('../output/relationship/VI_step_data_division/disease_miRNA.npy').tolist()
    dis2gene_data = np.load('../output/relationship/VI_step_data_division/disease_gene.npy').tolist()
    dis2circ_data = np.load('../output/relationship/VI_step_data_division/disease_circRNA.npy').tolist()
    dis2lnc_data = np.load('../output/relationship/VI_step_data_division/disease_lncRNA.npy').tolist()
    mi2circ_data = np.load('../output/relationship/VI_step_data_division/miRNA_circRNA.npy').tolist()
    mi2lnc_data = np.load('../output/relationship/VI_step_data_division/miRNA_lncRNA.npy').tolist()
    mi2gene_data = np.load('../output/relationship/VI_step_data_division/miRNA_gene.npy').tolist()
