...
def data_division():
    ...
    if not os.path.exists('../output/relationship/VI_step_data_division/'):
        os.makedirs('../output/relationship/VI_step_data_division/')
    ...
    np.savez('../output/relationship/VI_step_data_division/dis2mi_train_val_test_idx.npz', train_idx=dis2mi_train_idx, val_idx=dis2mi_val_idx, test_idx=dis2mi_test_idx)

    gace_data = np.load('../output/relationship/VI_step_data_division/dis2mi_train_val_test_idx.npz')
    ...
    np.savez('../output/relationship/VI_step_data_division/dis2gene_train_val_test_idx.npz', train_idx=dis2gene_train_idx, val_idx=dis2gene_val_idx, test_idx=dis2gene_test_idx)
    ...
    np.savez('../output/relationship/VI_step_data_division/dis2circ_train_val_test_idx.npz', train_idx=dis2circ_train_idx, val_idx=dis2circ_val_idx, test_idx=dis2circ_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_division/dis2lnc_train_val_test_idx.npz', train_idx=dis2lnc_train_idx, val_idx=dis2lnc_val_idx, test_idx=dis2lnc_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_division/mi2circ_train_val_test_idx.npz', train_idx=mi2circ_train_idx, val_idx=mi2circ_val_idx, test_idx=mi2circ_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_division/mi2lnc_train_val_test_idx.npz', train_idx=mi2lnc_train_idx, val_idx=mi2lnc_val_idx, test_idx=mi2lnc_test_idx)
    print(1)
    ...
    np.savez('../output/relationship/VI_step_data_division/mi2gene_train_val_test_idx.npz', train_idx=mi2gene_train_idx, val_idx=mi2gene_val_idx, test_idx=mi2gene_test_idx)
    #
